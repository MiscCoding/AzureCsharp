...
namespace Microsoft.Azure.Management.Samples.Common
{
    public static class Utilities
    {
        ...
        public static void Log(string message)
        {
            ...
            using (System.IO.StreamWriter file = new System.IO.StreamWriter("Azure.Log", true))
            {
        ...
        private static string FormatCollection(IList<KeyVault.Fluent.Models.KeyPermissions> collection)
        {
            return string.Join(", ", collection);
        }

        private static string FormatCollection(IList<KeyVault.Fluent.Models.SecretPermissions> collection)
        {
            return string.Join(", ", collection);
        }
        ...
        public static void PrintDatabase(Sql.Fluent.ISqlDatabase database)
        {
